"""
Socratic Agent for Medical Microbiology Tutor
...
def run_socratic(input: str, case: str, history: List[Dict[str, str]], run_with_faiss: bool = config.USE_FAISS, model: str = None) -> str:
    """
